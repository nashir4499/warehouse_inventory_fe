                    ...
                    tambahKolom && ( // "?" if yang memiliki elsenya
                        <div className="col-md-5 offset-md-1 card-lain kat-kolom mt-2">
                            <form onSubmit={savePinjam}>
                                <input type="text" className="form-control" value={data.nama} onChange={(e) => handleChange('nama', e.target.value)} placeholder="Nama Kategori" />
                                <button className="btn btn-success mt-3" type="submit" >Simpan</button>
                            </form>
                        </div>
                    )
                }
                                    ...
                                    <tr key={kategori.id}>
                                        ...
                                        <td>
                                            <Fragment>
                                                ...
                                                <button className="btn btn-warning btn-sm" onClick={ubahKolom ? () => setUbahKolom(false) : () => Ukolom(kategori.id)}>Ubah</button>
                    ...
                    ubahKolom && ( // "?" if yang memiliki elsenya
                        <div className="col-md-5 offset-md-1 card-lain kat-kolom mt-3">
                            <form onSubmit={savePerubahan}>
                                <h6>Ubah Kategori</h6>
                                <input type="hidden" value={dataUbah.id} onChange={(e) => handleChangeUbah('id', e.target.value)} />
                                <input type="text" className="form-control" value={dataUbah.nama} onChange={(e) => handleChangeUbah('nama', e.target.value)} />
                                <button className="btn btn-success mt-3" type="submit" >Simpan</button>
                            </form>
                        </div>
                    )
