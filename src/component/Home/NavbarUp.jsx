...
function NavbarUp() {
    return (
        <nav class="navbar-glass fs--1 font-weight-semi-bold row navbar-top sticky-kit navbar navbar-expand-xl navbar-light">
            ...
            <a class="text-decoration-none navbar-brand text-left" id="topLogo" href="/">
                <div class="d-flex align-items-center">
                    <img class="mr-2" src={warehouse} alt="Logo" width="40" />
                    <span class="text-sans-serif">warehouse</span>
                </div>
            </a>
            ...
            <ul class="navbar-nav-icons ml-auto flex-row align-items-center navbar-nav">
                <li class="nav-item">
                    <a class="settings-popover nav-link" href="/dashboard-alt#!">
                ...
                <li class="dropdown nav-item">
                    <a aria-haspopup="true" href="#" class="pr-0 nav-link" aria-expanded="false">
                        <div class="avatar avatar-xl ">
                            <img class="rounded-circle " src="/static/media/3.cb95ae1b.jpg" alt="" />
                        </div>
                    </a>
                    <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-card dropdown-menu dropdown-menu-right">
                        <div class="bg-white rounded-soft py-2">
                            ...
                            <a href="#!" tabindex="0" role="menuitem" class="dropdown-item">Set status</a>
                            <a tabindex="0" role="menuitem" class="dropdown-item" href="/pages/profile">Profile &amp; account</a>
                            <a href="#!" tabindex="0" role="menuitem" class="dropdown-item">Feedback</a>
                            <div tabindex="-1" class="dropdown-divider"></div>
                            <a tabindex="0" role="menuitem" class="dropdown-item" href="/pages/settings">Settings</a>
                            <a tabindex="0" role="menuitem" class="dropdown-item" href="/authentication/basic/logout">Logout</a>
                        </div>
                    </div>
                </li>
            </ul>
